...
public class MainController {
	...
	public ModelAndView addTheatre(@ModelAttribute("myTheatreForm") Theatre theatre, BindingResult result,Map<String, Object> model) {
...
//	@RequestMapping(value = "/addShowPage_1", method = RequestMethod.GET) // Page for adding show
//	public String addShowPage_part1(@RequestParam("movie_id") Integer movieId) {
//		logger.info("addind show by chosing movie...");
//		List<Movie> myMovieList = movieService.findAll();
//		httpSession.setAttribute("movieDataItem", myMovieList);
//		httpSession.setAttribute("movie_id",movieId);
//		return "ChoseMoviePage_2";
//	}
//	
//	@RequestMapping(value = "/addShowPage_2", method = RequestMethod.GET) // Page for adding show
//	public String addShowPage_part2(@ModelAttribute("myShowForm") Show show) {
//
//		List<Theatre> myTheatreList = movieService.getTheatreByMovieId((Integer) httpSession.getAttribute("movie_id"));
//		logger.info("Displaying shows...");
//		httpSession.setAttribute("theatreDataItem", myTheatreList);
//		return "AddShowPage";
//	}
