...
<body>
	...
	<thead><tr><th>Add Movie</th></tr></thead>
		...
		<fo:form action="addMovieToDatabase" method="post" modelAttribute="myMovieForm">
			...
			<tr>
				<td>Genre</td>
				<td><fo:select path="genre" items="${genreDataItem}"/></td> 
			</tr>
			<tr>
			...
			<tr>
				...
				<td><fo:select path="movieReleaseDate" type="date" name="Movie Release Date" min="2019-09-30" max="2019-10-12">"></fo:select>></td>
				<td><span><fo:errors path="movieReleaseDate"/></span> </td>
			</tr>
			<tr>
				<td>
